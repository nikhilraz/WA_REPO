...
public class TransactionHistoryFilter implements Filter {
	...
	private static final org.slf4j.Logger Log= LoggerFactory.getLogger(TransactionHistoryFilter.class);
	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		producerService.produceMessage("TransactionHistoryMQ",httpServletResponse.getStatus(),dateTime);
